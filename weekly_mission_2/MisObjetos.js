...
// ejemplo 1 Creacion de un objeto
const myObject = {} // aqui se crea un objeto vacio
console.log("Ejemplo 1: crear un objeto vacio")
console.log(myObject)

//Ejemplo 2 aqui creo un objeto con propiedades
const myObject2 = {
    name: "Gerardo",
    age: 30
}
console.log("Ejemplo 2 este es un objeto con propiedades")
